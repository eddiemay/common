...
public abstract class PDFReport {
	...
	protected static PdfPCell createCell(String text) {
		return createCell(text, Font.NORMAL, Element.ALIGN_RIGHT);
	}

	protected static PdfPCell createCell(String text, int font) {
		return createCell(text, font, Element.ALIGN_RIGHT);
	}

	protected static PdfPCell createCell(String text, int font, int alignment) {
		PdfPCell cell = new PdfPCell(new Phrase(text, FontFactory.getFont(FontFactory.HELVETICA, 12, font)));
