...
public class DAOTestingImplTest {
	...
	public void testCreate() {
		...
		assertEquals(1, users.getResultCount());
		assertEquals(user, users.getResultList().get(0));
		...
		assertEquals(2, users.getResultCount());
		assertEquals(user, users.getResultList().get(0));
		assertEquals(user2, users.getResultList().get(1));
		...
		assertEquals(1, users.getTotalSize());
		assertEquals(1, users.getResultCount());
		assertEquals(user2, users.getResultList().get(0));
	}
}
